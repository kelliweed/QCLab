...
class CaseProvisionalDiagnosisWidget(TypesWidget):
    ...
    _properties.update({
        'macro': "bika_widgets/caseprovisionaldiagnosiswidget",
        'helper_js': ("bika_widgets/caseprovisionaldiagnosiswidget.js",),
        'helper_css': ("bika_widgets/caseprovisionaldiagnosiswidget.css",),
    })
