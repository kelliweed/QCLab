...
# action.permissions = (ManageBika,)
    ...
    def setupCatalogs(self, portal):
        ...
        addIndex(bac, 'DueDate', 'DateIndex')
        addIndex(bac, 'DateSampled', 'DateIndex')
        ...
        addIndex(bac, 'ClientUID', 'FieldIndex')
        addIndex(bac, 'Analyst', 'FieldIndex')
        addIndex(bac, 'ClientTitle', 'FieldIndex')
        addIndex(bac, 'RequestID', 'FieldIndex')
        addIndex(bac, 'ClientOrderNumber', 'FieldIndex')
