...
##                action.permissions = (ManageBika,)
    ...
    def setupPermissions(self, portal):
        ...
        mp(ManageSamples, ['Manager', 'LabManager', 'LabClerk', 'Doctor', 'Analyst', 'Sampler', 'Preserver', 'Owner'], 1)
        ...
        mp(permissions.ModifyPortalContent, ['Manager', 'LabManager', 'Owner', 'Analyst'], 0) # epid branch removes 'LabClerk', 'Analyst',  from the list
        mp(ManagePatients, ['Manager', 'LabManager', 'LabClerk', 'Owner'], 0)
