...
# action.permissions = (ManageBika,)
    ...
    def setupCatalogs(self, portal):
        ...
        addIndex(bsc, 'ObjPositionInParent', 'GopipIndex')
        ...
        addIndex(bsc, 'Accredited', 'FieldIndex')
        addIndex(bsc, 'Analyst', 'FieldIndex')
        addIndex(bsc, 'InstrumentType', 'FieldIndex')
        addIndex(bsc, 'InstrumentTypeName', 'FieldIndex')
        addIndex(bsc, 'Blank', 'FieldIndex')
        addIndex(bsc, 'CalculationTitle', 'FieldIndex')
        addIndex(bsc, 'CalculationUID', 'FieldIndex')
        addIndex(bsc, 'CalibrationExpiryDate', 'FieldIndex')
        addIndex(bsc, 'CategoryTitle', 'FieldIndex')
        addIndex(bsc, 'CategoryUID', 'FieldIndex')
        addIndex(bsc, 'ClientUID', 'FieldIndex')
        addIndex(bsc, 'DepartmentTitle', 'FieldIndex')
        addIndex(bsc, 'DuplicateVariation', 'FieldIndex')
        addIndex(bsc, 'Formula', 'FieldIndex')
        addIndex(bsc, 'Fullname', 'FieldIndex')
        addIndex(bsc, 'Hazardous', 'FieldIndex')
        addIndex(bsc, 'InstrumentTitle', 'FieldIndex')
        addIndex(bsc, 'Keyword', 'FieldIndex')
        addIndex(bsc, 'ManagerName', 'FieldIndex')
        addIndex(bsc, 'ManagerPhone', 'FieldIndex')
        addIndex(bsc, 'ManagerEmail', 'FieldIndex')
        addIndex(bsc, 'MaxTimeAllowed', 'FieldIndex')
        addIndex(bsc, 'Model', 'FieldIndex')
        addIndex(bsc, 'Name', 'FieldIndex')
        addIndex(bsc, 'PointOfCapture', 'FieldIndex')
        addIndex(bsc, 'Price', 'FieldIndex')
        addIndex(bsc, 'SamplePointTitle', 'KeywordIndex')
        addIndex(bsc, 'SamplePointUID', 'FieldIndex')
        addIndex(bsc, 'SampleTypeTitle', 'KeywordIndex')
        addIndex(bsc, 'SampleTypeUID', 'FieldIndex')
        addIndex(bsc, 'ServiceTitle', 'FieldIndex')
        addIndex(bsc, 'ServiceUID', 'FieldIndex')
        addIndex(bsc, 'TotalPrice', 'FieldIndex')
        addIndex(bsc, 'Unit', 'FieldIndex')
        addIndex(bsc, 'VATAmount', 'FieldIndex')
        addIndex(bsc, 'Volume', 'FieldIndex')
        addIndex(bsc, 'sortKey', 'FieldIndex')
        addIndex(bsc, 'MethodID', 'FieldIndex')
        addIndex(bsc, 'DocumentID', 'FieldIndex')
        ...
        addColumn(bsc, 'ObjPositionInParent')
        ...
        addColumn(bsc, 'Accredited')
        addColumn(bsc, 'InstrumentType')
        addColumn(bsc, 'InstrumentTypeName')
        addColumn(bsc, 'Blank')
        addColumn(bsc, 'CalculationTitle')
        addColumn(bsc, 'CalculationUID')
        addColumn(bsc, 'CalibrationExpiryDate')
        addColumn(bsc, 'CategoryTitle')
        addColumn(bsc, 'CategoryUID')
        addColumn(bsc, 'ClientUID')
        addColumn(bsc, 'DepartmentTitle')
        addColumn(bsc, 'DuplicateVariation')
        addColumn(bsc, 'Formula')
        addColumn(bsc, 'Fullname')
        addColumn(bsc, 'Hazardous')
        addColumn(bsc, 'InstrumentTitle')
        addColumn(bsc, 'Keyword')
        addColumn(bsc, 'ManagerName')
        addColumn(bsc, 'ManagerPhone')
        addColumn(bsc, 'ManagerEmail')
        addColumn(bsc, 'MaxTimeAllowed')
        addColumn(bsc, 'Model')
        addColumn(bsc, 'Name')
        addColumn(bsc, 'PointOfCapture')
        addColumn(bsc, 'Price')
        addColumn(bsc, 'SamplePointTitle')
        addColumn(bsc, 'SamplePointUID')
        addColumn(bsc, 'SampleTypeTitle')
        addColumn(bsc, 'SampleTypeUID')
        addColumn(bsc, 'ServiceTitle')
        addColumn(bsc, 'ServiceUID')
        addColumn(bsc, 'TotalPrice')
        addColumn(bsc, 'Unit')
        addColumn(bsc, 'VATAmount')
        addColumn(bsc, 'Volume')
