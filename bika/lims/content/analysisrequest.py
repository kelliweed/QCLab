...
schema = BikaSchema.copy() + Schema((
    ...
    ReferenceField('Provider',
        required = 1,
        vocabulary = 'getProvidersDisplayList',
        default_method = 'getProviderUIDForUser',
        vocabulary_display_path_bound = sys.maxint,
        allowed_types = ('Contact',),
        referenceClass = HoldingReference,
        relationship = 'AnalysisRequestProvider',
    ),
    ComputedField('ProviderUID',
        expression='context.getProvider() and context.getProvider().UID() or None',
